...
import { getKpiMetrics, getProperty } from "@/lib/notion-queries";
...
export async function GET(req: NextRequest) {
  ...
  try {
    return ok(await getKpiMetrics(propertyId));
  } catch (e) {
    console.error("GET /api/data/kpi-records", e);
    return err("Failed to fetch KPI records");
  }
}
