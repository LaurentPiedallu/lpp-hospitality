...
import { getOpportunities, getProperty } from "@/lib/notion-queries";
...
export async function GET(req: NextRequest) {
  ...
  try {
    return ok(await getOpportunities(propertyId));
  } catch (e) {
    console.error("GET /api/data/opportunities", e);
    return err("Failed to fetch opportunities");
  }
}
