...
import { getActions, getProperty } from "@/lib/notion-queries";
...
export async function GET(req: NextRequest) {
  ...
  try {
    return ok(await getActions(propertyId));
  } catch (e) {
    console.error("GET /api/data/actions", e);
    return err("Failed to fetch actions");
  }
}
